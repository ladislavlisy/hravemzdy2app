...
- (id)init {
    if (!(self=[super initWithCodeRefer:[PYGSymbolTags codeRef:TAG_INSURANCE_SOCIAL_BASE]
                               andTitle:NSLocalizedString(@"TAG_TITLE_INSURANCE_SOCIAL_BASE", @"Assessment base for Social insurance")
                         andDescription:NSLocalizedString(@"TAG_DESCRIPT_INSURANCE_SOCIAL_BASE", @"Assessment base for Social insurance")
