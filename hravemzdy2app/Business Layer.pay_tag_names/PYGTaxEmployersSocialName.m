...
- (id)init {
    if (!(self=[super initWithCodeRefer:[PYGSymbolTags codeRef:TAG_TAX_EMPLOYERS_SOCIAL]
                               andTitle:NSLocalizedString(@"TAG_TITLE_TAG_TAX_EMPLOYERS_SOCIAL", @"Tax employer’s Social insurance")
                         andDescription:NSLocalizedString(@"TAG_DESCRIPT_TAG_TAX_EMPLOYERS_SOCIAL", @"Tax employer’s Social insurance")
